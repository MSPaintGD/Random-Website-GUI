...
root = Tk()
root.title("Random Game GUI")
root.geometry("700x700")
root.configure(bg="#add8e6")

title_label = Label(root, text="RGGUI", font=("Raleway", 20, "bold"), pady=10, bg="#ffffff")
title_label.pack()
...
text_to_copy = """function KeyboardInputManager() {
...
create_section(root, "2048 Script", copy_code)

text_to_copy2 = """Runner.instance_.distanceRan = 99999 / Runner.instance_.distanceMeter.config.COEFFICIENT"""

def copy_code():
    pyperclip.copy(text_to_copy2)

create_section(root, "Dino Game Score", copy_code)

text_to_copy3 = """Runner.instance_.tRex.setJumpVelocity(10)"""

def copy_code():
    pyperclip.copy(text_to_copy3)

create_section(root, "Dino Game Speed (change if you want)", copy_code)

text_to_copy4 = """var original = Runner.prototype.gameOver"""

def copy_code():
    pyperclip.copy(text_to_copy4)

create_section(root, "Dino Game DI IMMORTALES!", copy_code)

text_to_copy5 = """Runner.instance_.tRex.setJumpVelocity(200)"""

def copy_code():
    pyperclip.copy(text_to_copy5)

create_section(root, "Dino Game Jump Height", copy_code)

text_to_copy6 = """var runner = Runner.instance_;
...
create_section(root, "Dino Game No Cacti", copy_code)

text_to_copy7 = """function TrexRunnerBot() {
...
def copy_code():
    pyperclip.copy(text_to_copy7)

create_section(root, "Dino Game Bot", copy_code)
